"""Tests for src/rst_parser.py using synthetic RST fixtures.

iter_headers (MITgcm-specific) is tested in tests/mitgcm_docs_indexer/test_parse.py.
"""
...
from src.rst_parser import _clean_text, _is_underline, _split_sections, iter_sections
