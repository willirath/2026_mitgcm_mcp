"""Compute dimensionless numbers and flag issues for ocean model configurations.
...
def check_scales(
    ...
    """Compute dimensionless numbers and flag issues for an ocean model configuration.
