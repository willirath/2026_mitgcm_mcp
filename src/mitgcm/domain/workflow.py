...
_META: dict = {
    ...
    "agents_md_snippet": (
        ...
        "- Prefer MCP tools over reading MITgcm source directly.\n"
    ...
    "fallback_policy": [
        {
            ...
            "command": "git clone --depth 1 https://github.com/MITgcm/MITgcm /tmp/mitgcm-src",
            "note": (
        ...
        },
        {
            ...
            "recommendation": "Full clone to data/mitgcm-src/ (gitignored)",
            "command": "git clone https://github.com/MITgcm/MITgcm data/mitgcm-src",
        ...
        },
        {
            ...
            "command": "git submodule add https://github.com/MITgcm/MITgcm data/mitgcm-src",
            "note": "Use only if you need to pin a specific MITgcm commit in your repo.",
            "default": False,
        },
    ],
    "gap_report_format": (
